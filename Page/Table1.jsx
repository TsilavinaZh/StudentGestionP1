          ...
          <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Student Table</li>
              </ol>
              <h6 class="font-weight-bolder mb-0">Student Table</h6>
            </nav>
              ...
              <table class="table align-items-center mb-0">
                <thead>
                  <tr>
                    ...
                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">NaN</th>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex px-2 py-1">
                        ...
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm">Tsilavina</h6>
                          <p class="text-xs text-secondary mb-0">Razanamalala Tendry Tsilanina</p>
                        </div>
                      </div>
                    </td>
                    <td>
                      <span class="text-secondary text-xs font-weight-bold">NaN</span>

                    </td>
                    <td class="align-middle text-center text-sm">
                      <span class="text-secondary text-xs font-weight-bold">Antsirabe</span>
                    </td>
