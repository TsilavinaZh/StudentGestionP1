      ...
      <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark bg-white" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link text-white " href="/Table1">
                <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i class="material-icons opacity-10">table_view</i>
                </div>
                <span class="nav-link-text ms-1">Table Student</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-white " href="/Calendrier">
                <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i class="material-icons opacity-10">Calendrier</i>
                </div>
            ...
            <li class="nav-item">
              <a class="nav-link text-white " href="/Profil">
                <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i class="material-icons opacity-10">Profil</i>
                </div>
            ...
            <li class="nav-item">
              <a class="nav-link text-white " href="/Registre">
                <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i class="material-icons opacity-10">Sign up</i>
                </div>
